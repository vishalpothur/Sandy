...
function ServiceCard({ service }) {
  return (
    <div className="relative group bg-white rounded-3xl p-8 flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(232,165,152,0.25)] border border-cream-3">
      ...
      <div className="absolute top-5 right-5 w-2 h-2 rounded-full opacity-30 transition-opacity duration-300 group-hover:opacity-60"
        style={{ background: service.color }} />

      <div className="text-5xl mb-5 transition-transform duration-300 group-hover:scale-110 origin-left">
        {service.emoji}
      </div>
