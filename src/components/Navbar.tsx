    ...
    <>
      <nav
        ...
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${
          scrolled ? 'bg-cream/95 backdrop-blur-md shadow-sm' : 'bg-cream/80 backdrop-blur-sm'
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#hero" onClick={(e) => handleNav(e, '#hero')} className="flex flex-col leading-none cursor-pointer">
      ...
      <div className={`fixed inset-0 z-[99] bg-cream/98 backdrop-blur-xl flex flex-col items-center justify-center transition-all duration-500 ${menuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
